...
Clone with a destination and retain the working tree:
	...
	def create_repo(self, name_with_owner: str, *, private: bool = False, description: str | None = None, source: str | None = None) -> bool: ...
...
class GithubApi:
	...
	def push_initial_commit(self, repo_path: str | Path, name_with_owner: str, *, branch: str = "main", message: str = "init commit") -> None: ...
